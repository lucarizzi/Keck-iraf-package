...
procedure ccd_geom (a, sys, use_default)

real	a[NCCD,3]
double	sys[NPARAM]		# system params
int	use_default		# use default (rather than variable) values
...
define		X_CRAD	16		# x centering radius
define		Y_CRAD	16		# y centering radius
