...
# rev 0080508 -- moved fp_coord, gnom_to_dproj from keck_util.x b/c plate scale,
#		 etc. is instrument specific due to pullback

# DEIMOS_UTIL:  various utilities for DEIMOS,
#	FP_COORD:  calculates gnomonic projection to focal plane # OBSOLETE??
...
include	"deimos.h"
include	"keck.h"	# required only for SKY_GEOM
