#-----------------------------------------------------------------------
procedure dmosdisplay( image, frame)
#-----------------------------------------------------------------------
# Name:
#	dmosdisplay
# 
# Purpose:
#	Send DEIMOS mosaic image to IRAF imtool
# 
# Author:
...
#-----------------------------------------------------------------------
string  image		{ prompt="Name of input DEIMOS image" }
...
begin
    ...
    real    iz1
    real    iz2
    int     nvidinp	# number of HDUs in DEIMOS image
    int     i		# counter
