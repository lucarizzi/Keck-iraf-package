...
#	coeff  = pix-off + nom.gap	+ adjustment
	...
	a[1,1] = -1.5 * xdimeff		+ -12.19	+ -1.23
	a[1,2] = -0.5 * ydimeff		+ -16.63	+ -1.04
	a[1,3] = 0.			+ DEGTORAD(0.2544 + -0.0177)

	a[2,1] = -0.5 * xdimeff		+  -8.55	+ -0.20
	a[2,2] = -0.5 * ydimeff		+ -19.55	+ -0.33
	a[2,3] = 0.			+ DEGTORAD(0.1622 + -0.0146)

	a[3,1] =  0.5 * xdimeff
	a[3,2] = -0.5 * ydimeff
	a[3,3] = 0.

	a[4,1] =  1.5 * xdimeff		+  13.47	+ 0.23
	a[4,2] = -0.5 * ydimeff		+  12.66	+ 0.08
	a[4,3] = 0.			+ DEGTORAD(-0.1396 + 0.0223)

	a[5,1] = -1.5 * xdimeff		+ -33.48	+ -0.61
	a[5,2] =  0.5 * ydimeff		+  12.66	+ -0.44
	a[5,3] = 0.			+ DEGTORAD(0.1491 + 0.0002)

	a[6,1] = -0.5 * xdimeff		+ -14.63	+ 0.28
	a[6,2] =  0.5 * ydimeff		+   5.13	+ -0.87
	a[6,3] = 0.			+ DEGTORAD(0.2633 + -0.0059)

	a[7,1] =  0.5 * xdimeff		+ -23.00	+ 0.59 
	a[7,2] =  0.5 * ydimeff		+  25.77	+ -1.30
	a[7,3] = 0.			+ DEGTORAD(0.0451 + -0.0071)

	a[8,1] =  1.5 * xdimeff		+ -10.75	+ 0.17
	a[8,2] =  0.5 * ydimeff		+  48.04	+ -1.53
	a[8,3] = 0.			+ DEGTORAD(-0.0062 + -0.0045)
...
# added 01/09/04:
		    ...
		    call bx_recenter (im, Memr[bufx], Memr[bufy], nslit, xsz, ysz*anamf)
