...
define		KEYSFILE1	"lredtest$lib/keys/boxfind.key"
define		KEYSFILE2	"lredtest$lib/keys/maskalign.key"
...
# emphasize X spacing:
	...
	aerr = EOFFSET[stats]		# err (tan(pa)), radians
        call printf ("Rotational error is A: %f")
        call pargr (aerr) 
	a = atan (a)
	axx = cos (a)
	axy = -sin (a)
...
# emphasize X spacing:
		...
		a = OFFSET[stats]		# tan(pa), radians
		aerr = EOFFSET[stats]		# err (tan(pa)), radians
        call printf ("Rotational error is B: %f")
        call pargr (aerr) 
...
# Print stats again on text plane
	...
	coeff[2,3] = by
	err[1] = aerr
        call printf ("Rotational error is C: %f")
        call pargr (aerr) 
...
begin
 ...
 #		tester = EOFFSET[stats]
 #		call printf ("Rotational error is D: %f")
 #               call pargr (tester) 
 #		tester = MEI[stats]
 #		call printf ("MEI is: %f")
 #               call pargr (tester) 
...
#        call printf ("\n First image section = %f %f %f %f ")
#        call pargr ( x[1])
#        call pargr ( x[nx])
#        call pargr ( y[1])
#        call pargr ( y[ny])
#        call printf ("\n First image sub section = %f %f %f %f ")
#        call pargr ( x[i1])
#        call pargr ( x[i2])
#        call pargr ( y[j1])
#        call pargr ( y[j2])
...
# calculate the maximum sensible search range:
	...
	if (cx == INDEF || cy == INDEF)
		return (ERR)
#        call printf (" Box Coordinates on first pass are  = %f %f ")
        call pargr (cx)
        call pargr (cy)
...
#        call printf ("\n Second image section = %f %f %f %f ")
#        call pargr ( x[1])
#        call pargr ( x[nx])
#        call pargr ( y[1])
#        call pargr ( y[ny])
#        call printf ("\n Second image sub section = %f %f %f %f ")
#        call pargr ( x[i1])
#        call pargr ( x[i2])
#        call pargr ( y[j1])
#        call pargr ( y[j2])
...
#        call printf (" Box Coordinates on second pass are  = %f %f ")
        call pargr (cx)
        call pargr (cy)
...
# may cheat and assign the negative value:
	...
	xcen = (nx+1) /2
#	x = fractpos * (xcen-ineg) + (1. - fractpos) * (xcen-ipos)
#        call printf ("\nX = %f")
#        call pargr  (x)
