define	FLIPX	-1.d0		# X-flip for front milling
...
# Ready to display and be interactive
	call gselect_targ (tdat, ntarg, indat)
...
#	call write_surfcam_holes (sdat, nslit, fdc, maskid)
	...
	if (strne (plotfile, "")) {
call eprintf ("Plotting broken here\n")
...
begin
	...
	do i = 0, nslit-1 {
		call fprintf (fdc, "%10.4f %10.4f 0.00000\n")
			call pargd (XMM1(sdat,i)*FLIPX)
			call pargd (YMM1(sdat,i))
		call fprintf (fdc, "%10.4f %10.4f 0.00000\n")
			call pargd (XMM2(sdat,i)*FLIPX)
			call pargd (YMM2(sdat,i))
		call fprintf (fdc, "%10.4f %10.4f 0.00000\n")
			call pargd (XMM3(sdat,i)*FLIPX)
			call pargd (YMM3(sdat,i))
		call fprintf (fdc, "%10.4f %10.4f 0.00000\n")
			call pargd (XMM4(sdat,i)*FLIPX)
